...
**The NAS you already have** (Synology at 192.168.5.100) is not suitable for LLM inference — it lacks a GPU. The classification task is too latency-sensitive for CPU-only inference.
