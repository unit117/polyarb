...
export default function DeploymentNas() {
  return (
    <>
      ...
      <P>
        PolyArb runs on a Synology NAS at <Code>192.168.5.100</Code>. Deployment is done
...
cat /tmp/polyarb.tar.gz | ssh applecat@192.168.5.100 \\
...
ssh applecat@192.168.5.100 \\
  "cd /volume1/docker/polyarb && \\
   ...
   docker compose up -d"`}</CodeBlock>
      ...
      <CodeBlock lang="bash">{`ssh applecat@192.168.5.100 \\
  "cd /volume1/docker/polyarb && \\
